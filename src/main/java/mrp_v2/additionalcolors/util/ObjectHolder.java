...
public class ObjectHolder
{
    ...
    public static final List<ColorizedBlockData<?>> COLORIZED_BLOCK_DATAS = new ArrayList<>();
    ...
    static
    {
        ...
        for (ColorizedBlockData<?> blockEntry : COLORIZED_BLOCK_DATAS)
        {
    ...
    {
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockEntry(Blocks.OBSIDIAN, Tags.Items.OBSIDIAN,
                Util.makeTagArray(Tags.Blocks.OBSIDIAN), Util.makeTagArray()));
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockEntry(Blocks.COBBLESTONE, Tags.Items.COBBLESTONE,
                Util.makeTagArray(Tags.Blocks.COBBLESTONE), Util.makeTagArray()));
        COLORIZED_BLOCK_DATAS
                .add(new ColorizedBlockEntry(Blocks.STONE, Tags.Items.STONE, Util.makeTagArray(Tags.Blocks.STONE),
                        Util.makeTagArray()));
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockEntry(Blocks.SMOOTH_STONE,
        ...
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockData<ColoredCryingObsidianBlock>(
                ...
                false, Items.CRYING_OBSIDIAN.getRegistryName(), true, ItemTags.createOptional(
        ...
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_slab",
                ...
                null, null, false, new ResourceLocation(AdditionalColors.OBSIDIAN_EXPANSION_ID, "crying_obsidian_slab"),
        ...
        COLORIZED_BLOCK_DATAS
                .add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_stairs",
        ...
        COLORIZED_BLOCK_DATAS.add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_door",
                ObjectHolder.CRYING_OBSIDIAN_COLORS,
        ...
        COLORIZED_BLOCK_DATAS
                .add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_glass",
                        ...
                        (block, generator) -> generator.addLootTable(block, generator::registerSilkTouch),
                        (block, generator, consumer) ->
                        {
        ...
        COLORIZED_BLOCK_DATAS
                .add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_fence",
                        ObjectHolder.CRYING_OBSIDIAN_COLORS,
        ...
        COLORIZED_BLOCK_DATAS
                .add(new ColorizedBlockData<>(Blocks.CRYING_OBSIDIAN.getRegistryName().getPath() + "_fence_gate",
